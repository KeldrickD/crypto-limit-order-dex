...
export default function Notification() {
  const { error, successMessage, clearMessages } = useOrders();
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50 max-w-md">
      {error && (
        <div className="mb-4 rounded-md bg-red-50 p-4 shadow-lg border border-red-100">
          <div className="flex">
      ...
      {successMessage && (
        <div className="mb-4 rounded-md bg-green-50 p-4 shadow-lg border border-green-100">
          <div className="flex">
            <div className="flex-shrink-0">
